...
<head runat="server">
    <title>Active Plans - Luminex</title>
    <style>
        /* Global Styles */
        body {
...
<body>
    ...
    <ul>
        ...
        <div class="hero">
            <h1>Active Plans</h1>
            <p>View your active plans and usage details.</p>
        </div>
        ...
        <div class="container">
            <br />
            <br />
            <asp:Label ID="Label1" runat="server" Text="Here are your active plans and usage details" ForeColor="WhiteSmoke" Font-Bold="true"></asp:Label>
            <br />
            <br />
