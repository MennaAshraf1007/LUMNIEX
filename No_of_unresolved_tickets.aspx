...
<head runat="server">
    <title>Unresolved Tickets - Luminex</title>
    <style>
        body {
...
<body>
    ...
    <ul>
        ...
        <div class="hero">
            ...
            <p>View unresolved tickets for a customer.</p>
        </div>

        <!-- Form Container -->
        <div class="container">
            <asp:Label ID="Label1" runat="server" Text="Enter National ID" Font-Bold="true"></asp:Label>
            <br />
            <asp:TextBox ID="NationalID" runat="server" placeholder="Enter National ID" CssClass="textbox"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" OnClick="ShowUnresolvedTickets" Text="Show Unresolved Tickets" CssClass="button" />
            <br />
            <br />
            <asp:Label ID="ErrorMessage" runat="server" CssClass="error-message"></asp:Label>
        </div>

        <!-- GridView for Tickets -->
        <div class="container">
            <asp:GridView ID="gvTickets" runat="server" AutoGenerateColumns="True" CssClass="grid-view"></asp:GridView>
        </div>
