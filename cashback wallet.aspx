<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cashback_wallet.aspx.cs" Inherits="WebApplication1.cashback_wallet" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Cashback Wallet - Luminex</title>
    <style>
        body {
...
<body>
    ...
    <ul>
        ...
        <!-- Hero Box -->
        <div class="hero">
            <h1>Cashback Wallet</h1>
            <p>Apply cashback to your wallet using payment and benefit IDs.</p>
        </div>

        <!-- Form Container -->
        <div class="container">
            <asp:Label ID="Label2" runat="server" Text="Payment ID" Font-Bold="true"></asp:Label>
            <br />
            <asp:TextBox ID="TextBox2" runat="server" placeholder="Enter Payment ID" CssClass="textbox"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="Label3" runat="server" Text="Benefit ID" Font-Bold="true"></asp:Label>
            <br />
            <asp:TextBox ID="TextBox3" runat="server" placeholder="Enter Benefit ID" CssClass="textbox"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" OnClick="cashbackpaywallet" Text="Apply Cashback" CssClass="button" />
            <br />
            <br />
