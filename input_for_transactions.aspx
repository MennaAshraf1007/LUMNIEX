<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="input_for_transactions.aspx.cs" Inherits="DBM3.input_for__transactions" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Transactions - Luminex</title>
    <style>
        /* Global Styles */
        body {
            margin: 0;
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="header">
                <h1>Transactions</h1>
                <p>Enter the account details to view the number of successful transactions.</p>
            </div>

            <!-- Input Fields -->
            <label for="TextBox1">Account Number</label>
            <asp:TextBox ID="TextBox1" runat="server" CssClass="textbox"></asp:TextBox>

            <!-- Button -->
            <asp:Button ID="Button1" runat="server" OnClientClick="gettransactions" Text="Get Transactions" CssClass="button" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Milestone2DB_24ConnectionString %>" SelectCommand="Account_Payment_Points" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="TextBox1" Name="mobile_num" PropertyName="Text" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </form>
