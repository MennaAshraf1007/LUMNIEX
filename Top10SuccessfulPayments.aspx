...
<head runat="server">
    <title>Top 10 Successful Payments - Luminex</title>
    <style>
        /* Global Styles */
        body {
...
<body>
    ...
    <ul>
        ...
        <div class="hero">
            ...
            <p>View your top 10 successful payments.</p>
        </div>

        <!-- GridView for Top 10 Payments -->
        <div class="container">
            <br />
<br />
            <asp:Label ID="Label1" runat="server" Text="Here are your top payments" ForeColor="WhiteSmoke" Font-Bold="true"></asp:Label>
            <br />
            <br />
            <asp:GridView ID="gvPayments" runat="server" AutoGenerateColumns="True" CssClass="grid-view"></asp:GridView>
            <br />
            <asp:Label ID="Message" runat="server" ForeColor="WhiteSmoke"></asp:Label>
        </div>
