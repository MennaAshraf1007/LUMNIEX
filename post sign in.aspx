...
<body>
    <div id="splash-screen">
        <img id="splash-logo" src="images/logo.png" alt="Luminex Logo" loading="lazy" />
        <div id="splash-text">Connecting You to What Matters The Most</div>
        <div id="progress-bar">
    ...
    <script>
        ...
        // Add 'splash-active' class to body during splash screen
        document.body.classList.add('splash-active');

        // Show main page after splash screen
        setTimeout(() => {
            document.getElementById('main-page').style.display = 'block';
            document.body.classList.remove('splash-active'); // Remove the class
