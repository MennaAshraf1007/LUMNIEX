...
<head runat="server">
    <title>Cashback by Wallet and Plan - Luminex</title>
    <style>
        /* Global Styles */
        body {
            margin: 0;
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            <!-- Header -->
            <div class="header">
                <h1>Cashback by Wallet and Plan</h1>
            ...
            <label for="TextBox2">Plan ID</label>
            <asp:TextBox ID="TextBox2" runat="server" CssClass="textbox"></asp:TextBox>

            <!-- Button -->
            <asp:Button ID="Button2" runat="server" OnClientClick="viewamount" Text="View Amount" CssClass="button" />
