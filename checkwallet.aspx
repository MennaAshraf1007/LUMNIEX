...
<head runat="server">
    <title>Check Wallet - Luminex</title>
    <style>
        /* Global Styles */
        body {
            margin: 0;
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="header">
                <h1>Check Wallet</h1>
                <p>Enter the mobile number to check the wallet details.</p>
            </div>
            ...
            <!-- Button -->
            <asp:Button ID="Button2" runat="server" OnClientClick="checkifwallet" Text="Check" CssClass="button" />

            <!-- Result Label -->
            <asp:Label ID="Message" runat="server" Font-Bold="true" ForeColor="#00FFAA"></asp:Label>
        </div>
    </form>
</body>
</html>