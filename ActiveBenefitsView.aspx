...
<head runat="server">
    <title>Active Benefits - Luminex</title>
    <style>
        /* Global Styles */
        body {
...
<body>
    ...
    <ul>
        ...
        <div class="hero">
            ...
            <p>View all your active benefits and their details.</p>
        </div>

        <!-- GridView for Active Benefits -->
        <div class="container">
            <asp:Label ID="Label1" runat="server" Text="Here are all the Active Benefits" ForeColor="WhiteSmoke" Font-Bold="true"></asp:Label>
            <br />
            <br />
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="benefitID" DataSourceID="SqlDataSource2" CssClass="grid-view">
                <Columns>
                    <asp:BoundField DataField="benefitID" HeaderText="Benefit ID" InsertVisible="False" ReadOnly="True" SortExpression="benefitID" />
