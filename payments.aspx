    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="header">
                ...
                <p>Stay updated with all your transactions. Every payment, every detail, right here.</p>
            </div>

            <!-- GridView -->
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="paymentID" DataSourceID="SqlDataSource1" CssClass="grid-view">
                <Columns>
