...
<head runat="server">
    <title>Unsubscribed Plans - Luminex</title>
    <style>
        /* Global Styles */
        body {
...
.navbar ul li:hover a {
    color: #FFD700;
        ...
        /* Subscribe Button */
        .service-plan-box .right-section .subscribe-button {
        ...
        .service-plan-box .right-section .subscribe-button:hover {
            background: linear-gradient(135deg, #1A2A6C, #008081);
...
<body>
    ...
    <ul>
        ...
        <div class="hero">
            ...
            <p>Explore plans you haven't subscribed to yet.</p>
        </div>
        ...
        <div class="container">
            <br />
            <br />
            <asp:Label ID="Label1" runat="server" Text="Here are the services that you haven't subscribed to... yet" ForeColor="WhiteSmoke" Font-Bold="true"></asp:Label>
            <br />
            <br />
