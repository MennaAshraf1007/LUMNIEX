<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="redeem_voucher.aspx.cs" Inherits="WebApplication1.redeem_voucher" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Redeem Voucher - Luminex</title>
    <style>
        body {
...
<body>
    ...
    <ul>
        ...
        <div class="hero">
            ...
            <p>Redeem your voucher and enjoy exclusive benefits!</p>
        </div>

        <!-- Form Container -->
        <div class="container">
            <asp:Label ID="Label1" runat="server" Text="Redeem Voucher" Font-Bold="true"></asp:Label>
            <br />
            <br />
            <asp:TextBox ID="TextBox2" runat="server" placeholder="Enter Mobile Number" CssClass="textbox"></asp:TextBox>
            <br />
            <br />
            <asp:TextBox ID="TextBox1" runat="server" placeholder="Enter Voucher ID" CssClass="textbox"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="RedeemVoucherButton" runat="server" OnClick="RedeemVoucher" Text="Redeem Voucher" CssClass="button" />
            <br />
            <br />
