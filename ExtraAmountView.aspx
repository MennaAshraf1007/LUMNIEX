...
<head runat="server">
    <title>Extra Amount - Luminex</title>
    <style>
        body {
...
<body>
    ...
    <ul>
        ...
        <div class="hero">
            <h1>Extra Amount</h1>
            <p>Check the extra amount for your service plan.</p>
        </div>

        <!-- Form Container -->
        <div class="container">
            <asp:Label ID="Label1" runat="server" Text="Please enter plan name" ForeColor="WhiteSmoke" Font-Bold="true"></asp:Label>
            <br />
            <br />
            <asp:TextBox ID="plan" runat="server" placeholder="Enter Plan Name" CssClass="textbox"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" OnClick="ViewAmount" Text="View Extra Amount" CssClass="button" />
            <br />
            <br />
